...
@intt = dso_local global i32 0, align 4
@ints = dso_local global [10000 x i32] zeroinitializer, align 16
@chat = dso_local global i32 0, align 4
@chas = dso_local global [10000 x i32] zeroinitializer, align 16
@c = dso_local global i32 0, align 4
@get2 = dso_local global [10000 x i32] zeroinitializer, align 16
@get = dso_local global [10000 x i32] zeroinitializer, align 16
...
attributes #1 = { noinline nounwind uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
