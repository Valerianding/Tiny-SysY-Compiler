; ModuleID = '96_matrix_add.bc'
source_filename = "96_matrix_add.c"
...
define dso_local i32 @add(float* %0, float* %1, float* %2, float* %3, float* %4, float* %5, float* %6, float* %7, float* %8) #0 {
  Br label %10
...
13:                                               ; preds = %10
  ...
  %40 = getelementptr inbounds float, float* %8, i64 %39
...
33:                                               ; preds = %10
  ...
  %43 = call i32 @add(float* %34, float* %35, float* %36, float* %37, float* %38, float* %39, float* %40, float* %41, float* %42)
  Br label %44
